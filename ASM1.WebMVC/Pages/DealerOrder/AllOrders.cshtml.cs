...
namespace ASM1.WebMVC.Pages.DealerOrder
{
    ...
    public class AllOrdersModel : BasePageModel
    {
        private readonly ISalesService _salesService;
        private readonly IDealerService _dealerService;

        public AllOrdersModel(ISalesService salesService, IDealerService dealerService)
        {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            try
            {
                ...
                Orders = await _salesService.GetOrdersByDealerAsync(dealer.DealerId);
                return Page();
            }
            catch (Exception ex)
            {
